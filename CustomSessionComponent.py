...
# [GCC 7.5.0]
# Embedded file name: C:\ProgramData\Ableton\Live 101 Suite\Resources\MIDI Remote Scripts\APC40_MkIIx\CustomSessionComponent.py
# Compiled at: 2019-06-18 01:08:36
...
class CustomSessionComponent(CompoundComponent):
    ...
    def _copy_value(self, value):
        if not self._copy_button != None:
            raise AssertionError
            if self.is_enabled():
                value or self.clip_slot_copy_handler._finish_copying()
        return
